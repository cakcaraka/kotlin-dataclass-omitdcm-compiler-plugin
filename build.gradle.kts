...
buildscript {
  dependencies {
    ...
    classpath("com.cakcaraka.omitdcm:omitdcm-gradle-plugin")
  }
}
...
apiValidation {
  ignoredProjects += listOf("sample-jvm", "omitdcm-compiler-plugin")
...
spotless {
  ...
  kotlin {
    ...
    suppressLintsFor {
      ...
      shortCode = "ktfmt"
      path =
        "omitdcm-compiler-plugin/src/main/kotlin/com/cakcaraka/omitdcm/compiler/fir/OmitDCMFirExtensionRegistrar.kt"
    }
  }
  kotlinGradle {
    target("**/*.kts", "*.kts")
...
dependencies { dokka(project(":omitdcm-annotations")) }
